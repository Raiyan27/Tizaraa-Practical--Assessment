    ...
    <div className="bg-white rounded-lg border-2 border-gray-200 p-6 space-y-4">
      ...
      <div className="space-y-2">
        ...
        {colorVariant && colorVariant.priceModifier !== 0 && (
          <div className="flex justify-between text-sm">
            ...
            <PriceDisplay
              ...
              className={colorVariant.priceModifier > 0 ? 'text-green-600' : 'text-gray-600'}
            />
          </div>
        )}
        ...
        {materialVariant && materialVariant.priceModifier !== 0 && (
          <div className="flex justify-between text-sm">
            <span className="text-gray-600">Material ({materialVariant.name})</span>
            <PriceDisplay
              amount={materialVariant.priceModifier}
              className={materialVariant.priceModifier > 0 ? 'text-green-600' : 'text-gray-600'}
            />
          </div>
        )}
        ...
        {sizeVariant && sizeVariant.priceModifier !== 0 && (
          <div className="flex justify-between text-sm">
            ...
            <PriceDisplay
              ...
              className={sizeVariant.priceModifier > 0 ? 'text-green-600' : 'text-gray-600'}
            />
          </div>
        )}
        ...
        <div className="border-t pt-2">
          <div className="flex justify-between text-sm font-medium">
            ...
            <PriceDisplay amount={calculateProductPrice(product, selectedVariants, 1)} />
          </div>
        </div>
      </div>
      ...
      <div className="border-t pt-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <PriceDisplay amount={totalPrice} className="text-2xl text-blue-600" />
        </div>
