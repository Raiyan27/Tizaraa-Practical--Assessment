import { validateVariantCombination, checkVariantStock, getAvailableStock, isVariantIncompatible } from '../lib/validation';
...
describe('Validation', () => {
  const mockProduct: Product = {
    ...
    variants: {
      colors: [
        ...
        { id: 'neon', name: 'Neon', hex: '#FF00FF', priceModifier: 15, stock: 5, incompatibleWith: ['wood'] },
      ],
      materials: [
        { id: 'matte', name: 'Matte', priceModifier: 0, stock: 20 },
        { id: 'wood', name: 'Wood', priceModifier: 50, stock: 8, incompatibleWith: ['neon'] },
      ],
      sizes: [
  ...
  describe('validateVariantCombination', () => {
    ...
    it('should return error for incompatible color/material combination', () => {
      ...
      expect(errors.some(e => e.field === 'material' || e.field === 'color')).toBe(true);
    });
  ...
  describe('isVariantIncompatible', () => {
    it('should detect incompatible material with selected color', () => {
      ...
      const incompatible = isVariantIncompatible(mockProduct, 'materials', 'wood', selectedVariants);
