import { calculateProductPrice, calculateBundleDiscount, calculatePromoDiscount, calculateCartSummary } from '../lib/pricing';
...
describe('Pricing Engine', () => {
  const mockProduct: Product = {
    ...
    variants: {
      colors: [
        ...
        { id: 'blue', name: 'Blue', hex: '#0000FF', priceModifier: 10, stock: 10 },
      ],
      materials: [
  ...
  describe('calculateProductPrice', () => {
    ...
    it('should apply variant modifiers correctly', () => {
      ...
      const price = calculateProductPrice(mockProduct, variantsWithModifiers, 1);
  ...
  describe('calculateCartSummary', () => {
    ...
    it('should calculate complete cart summary correctly', () => {
      ...
      const summary = calculateCartSummary(cartItems, undefined, mockProductGetter);
    ...
    it('should apply shipping fee for orders under $75', () => {
      ...
      const summary = calculateCartSummary(cartItems, undefined, mockLowPriceGetter);
    ...
    it('should apply multiple discounts correctly', () => {
      ...
      const summary = calculateCartSummary(cartItems, promoCode, mockProductGetter);
